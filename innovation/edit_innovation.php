    ...
    <div id="app" v-for="data in info">
        ...
        <div class="form- text-center">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <input class="form-control" type="text" v-model="data.innovationName"></input>
                </div>
            </div>
        </div>
        ...
        <div v-if="isChild">
            ...
            <div v-for="comEnter in comEnterData" hidden>
                <input type="text" v-bind:value="comEnter.communityEnterpriseId == data.isComEnterprise? id_district = comEnter.addressCode : ''">
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-1">
                        <select v-model="id_province" @change="changeProvince()">
                            <option v-for="province in provinces" v-bind:value="province.id" :disabled="province.id == null">
                                {{ province.provinces }}
                            </option>
                        </select>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-1">
                        <select v-model="id_amphure" @change="changeAmphure()">
                            <option v-for="amphure in amphures" v-bind:value="amphure.id" :selected="amphure.id == id_amphure" :disabled="amphure.id == null">
                                {{ amphure.amphures }}
                            </option>
                        </select>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-1">
                        <select v-model="id_district" >
                            <option v-for="district in districts" v-bind:value="district.id" :disabled="district.id == null">
                                {{ district.districts }}
                            </option>
                        </select>
                    </div>
    ...
    var app = new Vue({
        ...
        methods: {
            ...
            updateData: function() {
                ...
                if (this.id_district != null && this.info[0]['innovationName'] &&
                    this.info[0]['background'] &&
                    this.info[0]['consistent'] &&
                    this.info[0]['otherDetail'] &&
                    this.info[0]['isComEnterprise']) {
                    ...
                    axios({
                            ...
                            data: {
                                innovationId: id,
                                innovationName: this.info[0]['innovationName'],
