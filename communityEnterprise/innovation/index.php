    ...
    <div id="app">
        ...
        <div class="container mt-3">
            ...
            <ul class="nav nav-tabs">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="">นวัตกรรม</a>
                </li>
                <li class="nav-item">
                    ...
                    <tr v-for="data in info">
                        <td class="text-left">
                            <a style="text-decoration: none;"
                                :href="'../../innovation/detail_innovation.php?id='+data.innovationId">{{ data.innovationName}}</a>
                        </td>
...
new Vue({
    ...
    methods: {
        getData: function() {
            let url = 'http://localhost/www/training/api/innovation';
            axios.get(url)
                .then(response => {
                    response.data
